...
jQuery.fn.extend({
    "initPage":function(listCount,currentPage,fun){
        var maxshowpageitem = jQuery(this).attr("maxshowpageitem");
        if(maxshowpageitem!=null&&maxshowpageitem>0&&maxshowpageitem!=""){
            page.maxshowpageitem = maxshowpageitem;
        }
        var pagelistcount = jQuery(this).attr("pagelistcount");
...
var  page = {
    ...
    "initPageEvent":function(listCount,fun){
        jQuery("#"+page.pageId +">li[class='pageItem']").on("click",function(){
            page.setPageListCount(listCount,jQuery(this).attr("page-data"),fun);
        });
    },
